...
movie <- movie %>%
  rename(FilmNoir = 'Film-Noir', SciFi = 'Sci-Fi',
         GameShow = 'Game-Show', RealityTV = 'Reality-TV')
```
...
# the outliers for gross appear to be real 
...
* Duration: over 190 minutes. Under 60 minutes
* Top few gross (real)
* Top few budget (real)
* Are there any film noir? game show? News? Reality? Short? 
  * Even how many war? western? (at least visible) Is it worth including these very small numbered genres?
* content_rating: approved? any Ms? Passed? X? NA?
