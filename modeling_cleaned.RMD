...
train %>% 
  ...
  scale_x_log10() + 
  labs(x = 'Log Real Gross Revenue ($)', y = 'Count', title = 'Histogram Real Revenue Actual vs Predicted: Not Complete') + 
...
lapply(c('real_budget', 'imdb_score'), function(var) {
  train_resid %>% 
    ...
    geom_hline(aes(yintercept = 0)) +
    labs(x = label(train_resid[str_c(var, '_log', sep = '')]), y = 'Log Residual') +
    scale_x_log10()
})
```
...
train %>% 
  ...
  scale_x_log10() + 
  theme(legend.position="bottom") + 
  labs(x = 'Log Real Gross Revenue ($)', y = 'Count', title = 'Histogram Real Revenue Actual vs Predicted') + 
  scale_color_manual(name = '', values = c(Actual = 'black', Predicted = 'red'))
```
...
train %>% 
  ...
  geom_freqpoly(aes(x = pred, color = 'Predicted')) +
  scale_x_log10() + 
  labs(x = 'Log Real Gross Revenue ($)', y = 'Count', title = 'Histogram Real Revenue Actual vs Predicted: Budget Only') + 
  scale_color_manual(name = '', values = c(Actual = 'black', Predicted = 'red'))
```
...
test %>% 
  ...
  scale_x_log10() + 
  theme(legend.position="bottom") + 
  labs(x = 'Log Real Gross Revenue ($)', y = 'Count', title = 'Histogram Real Revenue Real vs Predicted') + 
  scale_color_manual(name = '', values = c(Actual = 'black', Predicted = 'red'))
```
