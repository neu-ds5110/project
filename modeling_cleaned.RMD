...
```{r other_resid, fig.show = 'hide', message = F}
train_resid <- train %>% 
  add_residuals(mod_genre, 'lresid')
...
TO DO: 
*  Plot individual predictions for individual variables for mod_all
*  Add in mod_all2 for starting without genre
*  Write up justification for not including genre in final model
*  Fit model on test set (exlucde early years, log variables)
